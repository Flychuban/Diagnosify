...
with st.sidebar:
    ...
    selected_disease = option_menu("Select Disease", ["Diabetes", "Heart Disease", "Parkinson", "Kidney Disease", "Breast Cancer"],
    icons=['droplet', 'heart', 'person', 'clipboard2-heart', 'award'],
    default_index=0)
