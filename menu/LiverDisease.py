...
def liver_disease_menu():
    ...
    with col3:
        total_bilirubin = st.number_input("Total Bilirubin", min_value=0, value=0, step=1)
        
    with col1:    
        direct_bilirubin = st.number_input("Direct Bilirubin", min_value=0, value=0, step=1)
    ...
    with col2:
        total_protiens = st.number_input("Total Protiens", min_value=0, value=0, step=1)
